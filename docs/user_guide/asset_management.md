...
Permission for accessing the file system is asked from the user. This permission also allows reading the device's photos and videos folders. Hence, ordinary 2D content captured with the device's camera can be used in presentations.
...
1. On your computer, open a web browser and go here to download the iTunes application:
...
1. Your Android device came with a bundled *USB to micro USB* or *USB to USB-C* cable. It is the same one you use for charging your Android device. Connect your Android device to your computer using this cable.
...
1. On your computer, open a web browser and go here to download the Android File Transfer application:

    <https://www.android.com/filetransfer/>

    Once the download has completed, install the application on your computer just like any other app.

2. Your Android device came with a bundled *USB to micro USB* or *USB to USB-C* cable. It is the same one you use for charging your Android device. Connect your Android device to your computer using this cable.
...
1. In the first phase, plug the USB stick to your computer and copy all the assets there.

2. In the second phase, plug the USB stick to your mobile device and copy all the assets from the stick to **/Movies/LiveSYNC** on the mobile device.
...
![Assets](img/assets_usbstick_connection.png)
...
![Assets](img/assets_usbstick_integrated.png)
...
![Assets](img/assets_usbstick_filemanager.png)
