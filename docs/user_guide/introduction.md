...
However, if you can't wait to start using the app, we suggest you begin reading from [*Chapter 2. Installing*](installing.md). Continuing from there provides answers to *how*-questions. Return here when you are ready to find answers to *why*-questions. Or, dive into it now, especially if you are still looking for motivation to invest your time in 360-degree media.
...
Along the years many technological advancements made the web faster and faster. Step-by-step we started to use it for other forms of communication that require higher bandwidth. At first, images and GIF animations started to appear on web pages, then kids learned to share music as downloadable MP3s, then full-length movies. Low-latency streaming changed the landscape even more. Voice calls via Skype started to become popular, on-demand video rentals appeared, and Youtube showed up.  Eventually even traditional media gave up and took their newspapers, radio shows, and live TV broadcasts online. All forms of human communication became available for a single low-cost data plan. While a lot content is nowadays behind a paywall, there is also endless archives of free content. Nevertheless, new pricing model for web access and personal smartphones made it both possible and reasonable to stay online all day long.

As a consequence, we began to see a paradigm shift in human communication *from textual to visual representation*: Instead of writing long, carefully thought out emails we started to send lots of short messages that were delivered, read and replied to almost instantly. Tiny images called smileys were added by combining special characters. They were used to communicate common *feelings* by mimicking facial expressions. Then more complicated, graphical emojis arrived. Teens began to skip full sentences or words altogether by communicating with cryptic abbreviations and sequences of emojis. Kind of a modern version of the Egyptian hieroglyphs. Soon the textual part of a message was reduced to a mere caption or a foreword to a photograph we had just taken and wanted to share with the whole world. Now the image had become the message itself. Then we moved on to video and now live in the age of Youtube stars: basically anyone can start their own TV show with a press of a button.

> The world now is more visual that it has ever been in human history. 93% of all human communication is visual. ([Ref 1])

Why are we so fond of photos and videos? What is wrong with plain old books and letters? There is clearly room for all kinds of communication methods, as the new ones do not really *replace* the old ones; they add to the options that we have. Yet, we must embrace those methods that come so natural from us: the ones of visual kind. We can even argue that humans *are* visual by nature:
...
To simplify it, **the more visual a communication method is the faster we understand the message it carries**. We can only imagine the impact of widening the view from a small square to a full 360-degree experience. Or, we can start using it, and see the results ourselves.

[Ref 1]: https://tech.co/news/world-now-visual-ever-2017-01

### Interactivity Arouses Interest

The advances in imaging technology are pushing another paradigm shift: many features of photographs that have been traditionally decided *in advance* - when the camera shutter closes by latest - can now be changed *afterwards*. Up to the point where the person *viewing* the content becomes the decision maker.

For example, retouching images is so easy and commonplace that *photoshopping* has become a household word and a basic skill. Social media services provide vast amount of filters for spicing up captured photos; you simply take a photo and then select which result you like the most. Light-field cameras allow focusing the image *after* it has been taken (a stunt that seems almost impossible even for seasoned photographers!) These and many other new capabilities are all empowering the photographers. They allow postponing many artistic decisions to be made after the shot, which has a huge value to content production.

Also the cameras are evolving, to the point where we have to ask: What exactly is a camera? Or, who exactly was the photographer? Consider new phones that contain multiple physical camera modules. When you press the trigger, a set of images is captured: the camera modules trigger simultaneously and take many shots in sequence. Then, artificial intelligence is used for composing one perfect shot. Some of the frames are actually coming from a memory buffer and where taken *before* you pressed the trigger. Here the camera is a complex combination of hardware, software, and mathematical algorithms. The software is adopting the role of the photographer and becomes the key decision maker in the creation of the image. So, can we still justify calling the person that pressed the trigger the photographer? All he did was point the camera to a certain direction!
...
!!! example
    ...
    In reality, many clever solutions has and will be developed to reduce the need for bandwidth. This means that the capability to transmit high quality live 360-degree video streams is probably coming sooner than it appears when only bandwidth is considered.
...
This is the big picture. 360-degree imaging is already a mature and cost-effective enough to be used in daily activities. We can also see the fog disappearing and revealing the next stepping stone: while 360-degree video allows the viewer to turn around, *volumetric video* will remove the limitation that prevents the viewer from *taking a step* inside the world captured with cameras, and thus will make us feel being present even more. That technology is now taking its first steps and needs a few more years to begin to really work. Probably many more before the cameras and networks catch up!
...
Now that we have covered the big picture, it is time to discuss the LiveSYNC application and its role in 360-degree media creation and consumption. We will briefly summarize the history behind the LiveSYNC product as well as use cases that have been fundamental for designing the  user interface and features.

### Market

The rise of 360-degree content production did not went unnoticed for software companies and Internet giants. In the early days you needed special software for stitching 360-degree images and videos and for embedding such content on your website. Now, traditional video editing tools have been extended to support also 360-degree video. You can even stitch and photoshop a 360-degree photo with the actual Photoshop application. Previously, you needed a custom app if you wanted to play 360-degree video in a phone or a tablet. Today, most video sharing and social media services support at least basic monoscopic 360-degree photos and videos, many also allows watching the content in a VR headset. All of this is great if you want to shoot and share content to your friends, followers, or potential customers. In other words, if it is mostly for fun or mass-marketing.

But what about content that is not intended to be publicly available, or not allowed to be uploaded to 3rd party services, to be shown next to your competitor's ad? How about controlled situations, such as private product presentations or employee training? What about using 360-degree media as part of speeches and lectures? Or, using 360-degree content as a *canvas* for annotating points-of-interest and sharing this information as visual memos or work instructions? Images and videos are *very* versatile, and 360-degree variants make no exception.

Clearly there are many, many needs to satisfy. This means that many kinds of professional tools and services are needed. Solutions, that go beyond what the freemium mass-market services can offer. Moreover, the mass-market has started to grow slower than expected. Consumers have plenty of other options for entertainment and it is not easy to convince them to purchase yet another media device. Especially at times when technology develops fast many consumers tend to postpone purchasing as the next year's model is expected to be much better.

However, the professional market has no reason to wait for the consumer market to mature. The benefits of 360-degree media are available now. From consumer point-of-view, it is a question of spending money in exchange to yet another kind of entertainment. From professional point-of-view, it is an investment that can save a lot of money when done correctly. Postponing *spending* money can be well justified, but postponing *saving* money cannot.
